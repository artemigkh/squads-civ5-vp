...
--------------------------------------------------------
--------------------------------------------------------
function UpgradeAllUnits()
    print("Upgrade All Units Button Pressed")
    local iPlayer = Game.GetActivePlayer();
    local pPlayer = Players[ iPlayer ];

    for unit in pPlayer:Units() do print(unit:GetName()); print(unit:CanUpgradeRightNow()); end
...
Controls.UpgradeAllUnitsButton:RegisterCallback( Mouse.eLClick, UpgradeAllUnits);
